...
from cnn_train import FallDetectionCNN
...
def prediction(filepath, model, max_len, scaler):
    ...
    for file in filepath:
        ...
        with torch.no_grad():
            ...
            prediction = "FALL" if probability > 0.33 else "NOT FALL"
...
if __name__ == '__main__':
    ...
    parameters = torch.load('cnn_fall_detection.pth',weights_only=False)

    num_features = parameters['num_features']
    model = FallDetectionCNN(num_features, 256, 128, 1)
